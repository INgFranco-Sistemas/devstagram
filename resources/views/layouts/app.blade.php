        ...
        <header class="p-5 border-b bg-white shadow">
            <div class="container mx-auto flex justify-between items-center">
                ...
                <nav class="flex gap-2 items-center">
                    <a class="flex items-center gap-2 bg-white border p-2 text-gray-600 rounded text-sm uppercase font-bold cursos-pointer" href="{{ route('posts.create') }}">
                    ...
                    <a class="font-bold uppercase text-gray-600" href="{{ route('posts.index', auth()->user()->username) }}">
